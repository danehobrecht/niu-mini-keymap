...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_planck_mit(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, _______, MO(1),    KC_SPC,     MO(2), KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [1] = LAYOUT_planck_mit(
        ...
        _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, _______, KC_4,    KC_5,    KC_6,    KC_LBRC, KC_RBRC,
