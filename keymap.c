...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |      | Mute | Vol- | Vol+ |      |      |      |      |      |   -  |   [  |  ]   |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |r_TOG |r_Mode|r_Hue-|      |      |      |      |      | l_B  | m_U  | r_B  |
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |r_TOG |r_Mode|r_Hue-|      |      |      |      |   \  | m_L  | m_D  | m_R  |
     * `-----------------------------------------------------------------------------------'
     */
    [1] = LAYOUT_planck_mit(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_EQL,
        _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, KC_MINS, KC_LBRC, KC_RBRC,
        _______, RGB_TOG, RGB_MOD, RGB_HUI, _______, _______, _______, _______, _______, KC_BTN1, KC_MS_U, KC_BTN2,
        _______, RGB_HUD, BL_TOGG, BL_STEP, _______,      KC_SPC,      _______, KC_BSLS, KC_MS_L, KC_MS_D, KC_MS_R
    ),
